...
&kp LCTRL,         &kp LALT,         &kp LGUI,            &kp LSHFT,         LG(TAB),                &kp LEFT,          &kp DOWN,          &kp UP,            &kp RIGHT,         &u_caps_word,      \
U_NA,              &kp ENTER,        &kp BSPC,       &kp LG(F),       LC(GRAVE),               &kp HOME,           &kp PG_DN,          &kp PG_UP,          &kp END,           &kp INS,           \
