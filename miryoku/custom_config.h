...
&kp GRAVE,         &kp EXCL,          &kp AT,           &kp HASH,           &kp DLLR,           &kp PRCN            &u_to_U_BASE,       &u_to_U_EXTRA,      &u_to_U_TAP,       U_BOOT,             \
...
&kp LCTRL,         &kp LALT,         &kp LGUI,            &kp LSHFT,         &kp LG(TAB),                &kp LEFT,          &kp DOWN,          &kp UP,            &kp RIGHT,         &u_caps_word,      \
U_NA,              &kp ENTER,        &kp BSPC,       U_NA,       U_NA,               &kp HOME,           &kp PG_DN,          &kp PG_UP,          &kp END,           &kp INS,           \
